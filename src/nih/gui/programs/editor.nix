    ...
    home-manager.users.${cfgUser.name} = {
      ...
      xdg = {
        configFile = {
          ...
          "sublime-text/Packages/Dockerfile".source = npins.sublime-text-docker;
          "sublime-text/Packages/GitGutter".source = npins.sublime-text-git-gutter;
          "sublime-text/Packages/User/GitGutter.sublime-settings".text = ''
            {
              "show_line_annotation": false
            }
          '';
          "sublime-text/Packages/Jinja2".source = npins.sublime-text-jinja;
          "sublime-text/Packages/Nix".source = npins.sublime-text-nix;
          "sublime-text/Packages/Nushell".source = npins.sublime-text-nushell;
          "sublime-text/Packages/TOML".source = npins.sublime-text-toml;
          "sublime-text/Packages/Catppuccin/catppuccin.sublime-color-scheme".source =
            let
              themeName = "Catppuccin ${lib.nih.capStr cfgPalette.variant}.sublime-color-scheme";
            in
          ...
          "sublime-text/Packages/Catppuccin/Preferences.sublime-settings".text =
            ...
            '';
          "sublime-text/Packages/NixOS/Preferences.sublime-settings".text = ''
            {
        ...
        mimeApps.defaultApplications =
          let
            defaults = [ "sublime_text.desktop" ];
          in
          {
            "application/json" = defaults;
            "application/xml" = defaults;
